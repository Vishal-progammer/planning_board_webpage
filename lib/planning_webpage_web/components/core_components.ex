defmodule PlanningWebpageWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PlanningWebpageWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PlanningWebpageWeb.Gettext, "errors", msg, opts)
    end
  end
